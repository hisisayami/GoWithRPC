...
func (cc *CategoryCreate) SetCategoryDescription(s string) *CategoryCreate {
	cc.mutation.SetCategoryDescription(s)
	return cc
}
...
func (cc *CategoryCreate) check() error {
	if _, ok := cc.mutation.CategoryID(); !ok {
		return &ValidationError{Name: "category_id", err: errors.New(`ent: missing required field "Category.category_id"`)}
	}
	...
	if _, ok := cc.mutation.CategoryDescription(); !ok {
		return &ValidationError{Name: "category_description", err: errors.New(`ent: missing required field "Category.category_description"`)}
	}
	return nil
}
...
func (cc *CategoryCreate) createSpec() (*Category, *sqlgraph.CreateSpec) {
	...
	if value, ok := cc.mutation.CategoryDescription(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
